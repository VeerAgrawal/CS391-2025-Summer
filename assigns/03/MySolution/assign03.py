...
styp_chnum = styp_fun(styp_fun_int_int, styp_fun(styp_int, styp_int))
...
# HX-2025-06-10: tuple and let constructs
class term_tup(term):
    def __init__(self, arg1, arg2):
        self.arg1 = arg1
        self.arg2 = arg2
...
def term_tpck01(tm0, ctx):
    ...
    if (tm0.ctag == "TMfst"):
        stp = term_tpck01(tm0.arg1, ctx)
        assert stp.ctag == "STtup"
        return stp.arg1
    if (tm0.ctag == "TMsnd"):
        stp = term_tpck01(tm0.arg1, ctx)
        assert stp.ctag == "STtup"
    ...
    if (tm0.ctag == "TMlet"):
        ...
        t1 = tm0.arg2
        t2 = tm0.arg3
        st1 = term_tpck01(t1, ctx)
        ctx1 = tctx_cons(x, st1, ctx)
        return term_tpck01(t2, ctx1)
    if (tm0.ctag == "TMif0"):
        tm1 = tm0.arg1
        st1 = term_tpck01(tm1, ctx)
...
chnum_mul = \
  term_lam("m", styp_chnum, \
    term_lam("n", styp_chnum, \
      term_lam("f", styp_fun_int_int, \
        term_lam("x", styp_int, \
          term_app( \
            term_app(var_m, term_app(var_n, var_f)), \
            var_x)))))

print("tpck(chnum_mul) = " + str(term_tpck00(chnum_mul)))

# Simple tests for tuples and let-bindings
tm_pair = term_tup(int_1, btf_t)
print("tpck(tm_pair) = " + str(term_tpck00(tm_pair)))
print("tpck(TMfst(tm_pair)) = " + str(term_tpck00(term_fst(tm_pair))))
print("tpck(TMsnd(tm_pair)) = " + str(term_tpck00(term_snd(tm_pair))))

tm_let = term_let("y", int_1, term_add(var_y, int_1))
print("tpck(tm_let) = " + str(term_tpck00(tm_let)))
